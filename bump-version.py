...
iSpector tries to live to the rule that a minor version that is stable ends
with an even number.
'''
...
ap.add_argument(
    '--set-major', help="set the major version", type=int, default=-1
)
ap.add_argument(
    '--set-minor', help="set the minor version", type=int, default=-1
)
ap.add_argument(
    '--set-micro', help="set the micro version", type=int, default=-1
)
...
# regular expressions to find the versioning info in iSpectorVersion.py
